...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='rocketfundcoin.conf'
CONFIGFOLDER='/root/.rocketfundcoin'
COIN_DAEMON='rocketfundcoind'
COIN_CLI='rocketfundcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/RocketFund/RocketFundCoin/releases/download/v1.0.0/RocketFundCoin-Linux-Daemon.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='rocketfundcoind'
COIN_EXPLORER='http://explorer.rocketblocks.org'
COIN_PORT=36145
RPC_PORT=36144
